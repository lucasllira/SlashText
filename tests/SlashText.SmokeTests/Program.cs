...
try
{
    ...
    using (var archive = ZipFile.OpenRead(backupFiles[0]))
    {
        Require(
            ...
            "backup contÃ©m atalhos, preferÃªncias e estatÃ­sticas");
    }
